    ...
    public class CGBCPU
    {
        ...
        private void ExecuteOperation(byte opCode)
        {
            switch (opCode)
            {
                ...
                case 0x36: Ram.Write(Registers.HL.Word, LD8(Registers.PC.Word)); Registers.PC++; break; // LD (HL),d8 . 2 12 . - - - -
                ...
                case 0x70: Ram.Write(Registers.HL.Word, Registers.B); break; // LD (HL),B . 1 8 . - - - -
                case 0x71: Ram.Write(Registers.HL.Word, Registers.C); break; // LD (HL),C . 1 8 . - - - -
                case 0x72: Ram.Write(Registers.HL.Word, Registers.D); break; // LD (HL),D . 1 8 . - - - -
                case 0x73: Ram.Write(Registers.HL.Word, Registers.E); break; // LD (HL),E . 1 8 . - - - -
                case 0x74: Ram.Write(Registers.HL.Word, Registers.H); break; // LD (HL),H . 1 8 . - - - -
                case 0x75: Ram.Write(Registers.HL.Word, Registers.L); break; // LD (HL),L . 1 8 . - - - -
                ...
                case 0x86: ADD(LD8(Registers.HL.Word)); break; // ADD A,L . 1 4 . Z 0 H C
                ...
                case 0x8E: ADC(LD8(Registers.HL.Word)); break; // ADC A,(HL) . 1 4 . Z 0 H C
                ...
                case 0x96: SUB(LD8(Registers.HL.Word)); break; // SUB HL . 1 8 . Z 1 H C
                ...
                case 0x9E: SUBC(LD8(Registers.HL.Word)); break; // SBC A,HL . 1 4 . Z 4 H C
                ...
                case 0xA6: AND(LD8(Registers.HL.Word)); break; // AND HL . 1 4 . Z 0 1 0
                ...
                case 0xAE: XOR(LD8(Registers.HL.Word)); break; // XOR HL . 1 4 . Z 0 0 0
                ...
                case 0xB6: OR(LD8(Registers.HL.Word)); break; // OR HL . 1 4 . Z 0 0 0 
                ...
                case 0xC6: ADD(LD8(Registers.PC.Word)); Registers.PC++; break; // ADD A,d8 . 2 8 . Z 0 H C
                ...
                case 0xCE: ADC(LD8(Registers.PC.Word)); Registers.PC++; break; // ADD A,d8 . 2 8 . Z 0 H C
                ...
                case 0xF6: OR(LD8(Registers.PC.Word)); Registers.PC++; break; // OR d8 . 2 8 . Z 0 0 0
        ...
        private void PREFIX_CB(ushort opCode)
        {
            switch (opCode)
            {
                ...
                case 0x2E: LD8(Registers.HL.Word, SRA(LD8(Registers.HL.Word))); break; // SRA HL . 2 16 . Z 0 0 C
        ...
        public virtual ushort LD16()
        {
            ...
            Registers.PC++;
            r.High = Ram.Read(Registers.PC.Word);
            Registers.PC++;
            return r.Word;
        }
        ...
        public virtual void JR(bool flag)
        {
            ...
            if (flag)
            {
                Registers.PC += (sbyte)Ram.Read(Registers.PC.Word);
            }
            Registers.PC++;
        }
        /// <summary>
        ...
        public virtual ushort POP()
        {
            ...
            Registers.SP++;
            var high = Ram.Read(Registers.SP);
            Registers.SP++;
        ...
        public virtual void CALL()
        {
            ...
            Registers.PC++;
            var high = Ram.Read(Registers.PC.Word);
            Registers.PC++;
            PUSH(Registers.PC.High, Registers.PC.Low);
